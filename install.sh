#!/usr/bin/env sh
# Universal installer for sbomb. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/sbomb.git"
echo "Installing sbomb ..."
