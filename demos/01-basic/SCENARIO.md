...
The scanner detects **7 components** (1 operating-system + 6 packages)
and flags **known vulnerabilities** using the bundled offline DB:

- `openssl 1.1.1k`  -> **CVE-2021-3711 (critical)** because `1.1.1k < 1.1.1l`.
- `zlib 1.2.11`     -> **CVE-2018-25032 (high)** because `1.2.11 < 1.2.12`.

`dropbear 2020.81`, `libcurl 7.88.0`, `musl`, and `requests` are **clean**
(their versions are above the vulnerable ranges).
