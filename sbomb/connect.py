"""Native cognis-connect emit for sbomb — forward findings to any platform.

Maps sbomb's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    sbomb ... --format json | sbomb-emit --to stix
    sbomb-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
